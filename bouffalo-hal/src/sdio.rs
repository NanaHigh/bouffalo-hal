...
impl TransferMode {
    ...
    /// If Block Count register is enabled.
    #[inline]
...
impl Command {
    ...
    /// If check the Index field is enabled.
    #[inline]
...
impl PresentState {
    ...
    /// If card detect pin level is stable.
    #[inline]
...
impl BlockGap {
    ...
    /// If block gap interrupt is enabled.
    #[inline]
...
impl WakeupControl {
    ...
    /// If Wakeup Event On SD Card Removal is enabled.
    #[inline]
    ...
    /// If Wakeup Event On SD Card Insertion is enabled.
    #[inline]
    ...
    /// If Wakeup Event On SD Card Interrupt is enabled.
    #[inline]
...
impl SoftwareReset {
    ...
    /// If dat line reset is finished (Cleared to 0).
    #[inline]
    ...
    /// If cmd line reset is finished (Cleared to 0).
    #[inline]
    ...
    /// If all reset is finished (Cleared to 0).
    #[inline]
...
impl ErrorInterruptStatus {
    ...
    /// If Command End Bit Error occurs.
    #[inline]
    ...
    /// If Command Timeout Error occurs.
    #[inline]
...
impl NormalInterruptStatusEnable {
    ...
    /// If Re-Tuning Event Status is enabled.
    #[inline]
    ...
    /// If Card Removal Status is enabled.
    #[inline]
    ...
    /// If Card Insertion Status is enabled.
    #[inline]
    ...
    /// If Buffer Read Ready Status is enabled.
    #[inline]
    ...
    /// If Buffer Write Ready Status is enabled.
    #[inline]
    ...
    /// If DMA Interrupt Status is enabled.
    #[inline]
    ...
    /// If Block Gap Status is enabled.
    #[inline]
    ...
    /// If Transfer Complete Status is enabled.
    #[inline]
    ...
    /// If Command Complete is enabled.
    #[inline]
...
impl ErrorInterruptStatusEnable {
    ...
    /// If Vendor Specific Error Status is enabled.
    #[inline]
    ...
    /// If Tuning Error Status is enabled.
    #[inline]
    ...
    /// If ADMA Error Status is enabled.
    #[inline]
    ...
    /// If Auto CMD Error Status is enabled.
    #[inline]
    ...
    /// If Current Limit Error Status is enabled.
    #[inline]
    ...
    /// If Data End Bit Error Status is enabled.
    #[inline]
    ...
    /// If Data CRC Error Status is enabled.
    #[inline]
    ...
    /// If Data Timeout Error Status is enabled.
    #[inline]
    ...
    /// If Command Index Error Status is enabled.
    #[inline]
    ...
    /// If Command End Bit Error Status is enabled.
    #[inline]
    ...
    /// If Command CRC Error Status is enabled.
    #[inline]
    ...
    /// If Command Timeout Error Status is enabled.
    #[inline]
...
impl NormalInterruptSignalEnable {
    ...
    /// If Re-Tuning Event Signal is enabled.
    #[inline]
    ...
    /// If Card Interrupt Signal is enabled.
    #[inline]
    pub const fn is_card_int_enabled(self) -> bool {
        (self.0 & Self::CARD_INT) >> 8 == 1
    }
    ...
    /// If Card Removal Signal is enabled.
    #[inline]
    pub const fn is_card_removal_enabled(self) -> bool {
        (self.0 & Self::CARD_REMOVAL) >> 7 == 1
    }
    ...
    /// If Card Insertion Signal is enabled.
    #[inline]
    pub const fn is_card_insertion_enabled(self) -> bool {
        (self.0 & Self::CARD_INSERTION) >> 6 == 1
    }
    ...
    /// If Buffer Read Ready Signal is enabled.
    #[inline]
    pub const fn is_buffer_read_ready_enabled(self) -> bool {
        (self.0 & Self::BUFFER_READ) >> 5 == 1
    }
    ...
    /// If Buffer Write Ready Signal is enabled.
    #[inline]
    pub const fn is_buffer_write_ready_enabled(self) -> bool {
        (self.0 & Self::BUFFER_WRITE) >> 4 == 1
    }
    ...
    /// If DMA Interrupt Signal is enabled.
    #[inline]
    pub const fn is_dma_int_enabled(self) -> bool {
        (self.0 & Self::DMA_INT) >> 3 == 1
    }
    ...
    /// If Block Gap Event Signal is enabled.
    #[inline]
    pub const fn is_block_gap_enabled(self) -> bool {
        (self.0 & Self::BLOCK_GAP) >> 2 == 1
    }
    ...
    /// If Transfer Complete Signal is enabled.
    #[inline]
    pub const fn is_transfer_complete_enabled(self) -> bool {
        (self.0 & Self::TRANSFER_COMPLETE) >> 1 == 1
    }
    ...
    /// If Command Complete Signal is enabled.
    #[inline]
    pub const fn is_cmd_complete_enabled(self) -> bool {
        self.0 & Self::CMD_COMPLETE == 1
    }
...
impl ErrorInterruptSignalEnable {
    ...
    /// If Vendor Specific Error Signal is enabled.
    #[inline]
    pub const fn is_vendor_specific_err_enabled(self) -> bool {
        (self.0 & Self::VENDOR_SPECIFIC_ERROR) >> 12 == 0xF
    }
    ...
    /// If Tuning Error Signal is enabled.
    #[inline]
    pub const fn is_tuning_err_enabled(self) -> bool {
        (self.0 & Self::TUNING_ERROR) >> 10 == 1
    }
    ...
    /// If ADMA Error Signal is enabled.
    #[inline]
    pub const fn is_adma_err_enabled(self) -> bool {
        (self.0 & Self::ADMA_ERROR) >> 9 == 1
    }
    ...
    /// If Auto CMD Error Signal is enabled.
    #[inline]
    pub const fn is_auto_cmd_err_enabled(self) -> bool {
        (self.0 & Self::AUTO_CMD_ERROR) >> 8 == 1
    }
    ...
    /// If Current Limit Error Signal is enabled.
    #[inline]
    pub const fn is_current_limit_err_enabled(self) -> bool {
        (self.0 & Self::CURRENT_LIMIT_ERROR) >> 7 == 1
    }
    ...
    /// If Data End Bit Error Signal is enabled.
    #[inline]
    pub const fn is_data_end_bit_err_enabled(self) -> bool {
        (self.0 & Self::DATA_END_BIT_ERROR) >> 6 == 1
    }
    ...
    /// If Data CRC Error Signal is enabled.
    #[inline]
    pub const fn is_data_crc_err_enabled(self) -> bool {
        (self.0 & Self::DATA_CRC_EROOR) >> 5 == 1
    }
    ...
    /// If Data Timeout Error Signal is enabled.
    #[inline]
    pub const fn is_data_timeout_err_enabled(self) -> bool {
        (self.0 & Self::DATA_TIMEOUE_ERROR) >> 4 == 1
    }
    ...
    /// If Command Index Error Signal is enabled.
    #[inline]
    pub const fn is_cmd_index_err_enabled(self) -> bool {
        (self.0 & Self::CMD_INDEX_EROOR) >> 3 == 1
    }
    ...
    /// If Command End Bit Error Signal is enabled.
    #[inline]
    pub const fn is_cmd_end_bit_err_enabled(self) -> bool {
        (self.0 & Self::CMD_END_BIT_ERROR) >> 2 == 1
    }
    ...
    /// If Command CRC Error Signal is enabled.
    #[inline]
    pub const fn is_cmd_crc_err_enabled(self) -> bool {
        (self.0 & Self::CMD_CRC_ERROR) >> 1 == 1
    }
    ...
    /// If Command Timeout Error Signal is enabled.
    #[inline]
    pub const fn is_cmd_timeout_err_enabled(self) -> bool {
        self.0 & Self::CMD_TIMEOUT_ERROR == 1
    }
...
impl HostControl2 {
    ...
    /// If Asynchronous Interrupt is enabled.
    #[inline]
    ...
    /// If changing card signal voltage from 3.3V to 1.8V is finished.
    #[inline]
    ...
    /// If changing card signal voltage from 1.8V to 3.3V is finished.
    #[inline]
...
impl Capabilities {
    ...
    /// If Asynchronous Interrupt Support is enabled.
    #[inline]
    pub const fn is_async_int_enabled(self) -> bool {
    ...
    /// If 64-bit System Bus Support is enabled.
    #[inline]
    ...
    /// If Voltage Support 1.8V is enabled.
    #[inline]
    ...
    /// If Voltage Support 3.0V is enabled.
    #[inline]
    ...
    /// If Voltage Support 3.3V is enabled.
    #[inline]
    ...
    /// If Suspend/Resume Support is enabled.
    #[inline]
    ...
    /// If 64-bit High Speed Support is enabled.
    #[inline]
    ...
    /// If 8-bit Bus Support for Embedded Device.
    #[inline]
    ...
    /// If Use Tuning for SDR50 is enabled.
    #[inline]
    ...
    /// If Driver Type D Support is enabled.
    #[inline]
    ...
    /// If Driver Type C Support is enabled.
    #[inline]
    ...
    /// If Driver Type A Support is enabled.
    #[inline]
...
impl ADMAErrorStatus {
    ...
    /// If ADMA Length Mismatch Error occurs.
    #[inline]
